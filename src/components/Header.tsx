...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-2 left-1/2 transform -translate-x-1/2 min-w-[80%] h-12 w-4/5 md:w-2/5 z-50">
        <GlassSurface 
          width='100%' 
          height={50}
          borderRadius={10}
        ...
        >
          <div className="px-3 py-4 flex justify-between items-center h-full relative transition-all duration-500">
            ...
            <div className="flex items-center">
              <Link href="/" className="text-2xl tracking-wider" style={{ fontFamily: "var(--font-philly-sans), sans-serif" }}>
                etrade
              </Link>
            </div>
            ...
            <div className="h-full w-full">
              <div className="flex items-center justify-between p-4 border-b border-gray-200">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={toggleSidebar}
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 text-gray-600 transition-all duration-300 hover:bg-gray-200"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <nav className="p-4">
                ...
                >
                  {[{ href: '/', label: 'Home' }, { href: '/about-us', label: 'About Us' }].map((item) => (
                    <motion.div
                      key={item.href}
                      variants={{
                        open: { x: 0, opacity: 1 },
                    ...
                    >
                      <Link
                        ...
                        className="flex items-center  w-full p-3 rounded-lg text-black hover:bg-white/10 transition-all duration-300"
                      >
