...
export default function Footer() {
  ...
  useEffect(() => {
    // Fetch social links from public directory
    fetch('/social.json')
      ...
      .catch(error => {
        ...
        setSocialLinks([
          ...
          {
            name: "Instagram",
            url: "https://instagram.com/etrade",
            icon: "instagram"
          },
          {
            name: "LinkedIn",
            url: "https://linkedin.com/company/etrade",
            icon: "linkedin"
          },
          {
            name: "YouTube",
            url: "https://youtube.com/etrade",
            icon: "youtube"
          }
        ]);
      });
